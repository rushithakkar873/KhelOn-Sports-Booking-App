  ...
  const handleSaveAndContinue = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        Alert.alert(
          "Error",
          result.message || "Failed to save venue information"
        );
      }
    } catch (error) {
        ...
        >
          ...
          <View style={styles.titleContainer}>
            ...
            <Text style={styles.description}>
              Essential information for your venue listing
            </Text>
          </View>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <Text style={styles.helperText}>
                We'll help you verify the exact location with Google Maps
              </Text>
            </View>
